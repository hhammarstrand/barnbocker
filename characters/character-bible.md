...
**Appearance:**
- Bright orange fur with cream-colored belly and snout
- Large, expressive dark eyes
- Fluffy white-tipped tail
- Small to medium size (child-appropriate proportions)
- Occasionally wears a colorful scarf or bow

**Distinguishing Features:**
- Big curious eyes that sparkle with wonder
- Small black nose
- Pointed ears with light inner color
- Soft, rounded features (not sharp or intimidating)

**Color Palette:**
- Primary: #E67E22 (bright orange)
- Secondary: #FDEBD0 (cream)
- Accent: #FFFFFF (white tail tip, belly)
- Details: #2C3E50 (eyes, nose)

### Personality Traits

1. **Curious** - Fifi loves exploring and asking questions
2. **Friendly** - Always ready to make new friends
3. **Brave** - Not afraid of new experiences (but age-appropriate bravery)
4. **Kind** - Shares with friends and helps others
5. **Playful** - Loves games, laughter, and fun

### Voice & Speech

- Speaks in short, simple sentences (appropriate for ages 1-5)
- Uses friendly, warm tone
- Often uses rhyming or repetitive phrases
- Asks lots of questions
- Voice description: "bright, cheerful, childlike wonder"
...
## Minimax Image Generation Prompts

### Base Character Prompt

```
A cute baby red fox with bright orange fur and cream-colored belly and snout. 
...
**Fifi in the forest:**
```
Adorable young red fox with orange fur and white-tipped tail exploring a magical 
forest. Large curious eyes looking around with wonder. Soft children's book 
illustration style. Warm golden sunlight filtering through trees. Friendly and 
adventurous expression.
```

**Fifi meeting a friend:**
```
Adorable young red fox with bright orange fur and fluffy white tail, standing 
next to a friendly bear cub. Both animals looking at each other with warm smiles. 
Children's book illustration with soft colors and gentle shapes. Sweet friendship 
scene.
```

**Fifi in pajamas/bedtime:**
```
Adorable young red fox with soft orange fur, wearing cozy pajamas with stars, 
yawning sleepily with big dark eyes. Cozy bedroom background. Children's book 
illustration with warm lamp light. Sweet and sleepy expression.
```

**Fifi celebrating:**
```
Adorable young red fox with fluffy white-tipped tail, jumping with joy with 
front paws raised. Happy expression with big smile. Colorful confetti around. 
Children's book celebration illustration with warm cheerful colors.
```
...
## Book Themes & Story Templates

1. **Friendship** - Fifi makes a new friend
2. **Adventure** - Fifi explores somewhere new  
3. **Emotions** - Fifi learns about feelings
4. **Nature** - Fifi discovers seasons/animals
5. **Bedtime** - Fifi's bedtime routine
6. **Sharing** - Fifi learns to share

---

## Visual Consistency Rules

1. **Always use the base character prompt** as the starting point
2. **Maintain orange/cream color scheme** for Fifi
3. **Keep expressions child-friendly** - happy, curious, surprised (never scary)
...
When generating illustrations for a Fifi story:

1. Use the base prompt + scene-specific variation
2. Include "Children's book illustration style"
3. Add character consistency elements from the base prompt
4. Specify warm lighting and soft colors
5. Ensure child-friendly expressions and poses